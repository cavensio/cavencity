...
from ui_counter import CvCounter
from ui_slider import CvSlider
...
class MainWindow(QMainWindow):
    ...
    def __create_master_panel(self) -> QGroupBox:
        ...
        self._master_count_lcdnumber = CvCounter()
    ...
    def __create_slave1_panel(self) -> QGroupBox:
        ...
        errors_label = QLabel()
        count_lcdnumber = CvCounter()
        damper_checkbox = QCheckBox()

        fan_slider = CvSlider('Fan speed')
        fan_slider.valueChanged.connect(self.__on_slave1_fan_level_changed)
        light_slider = CvSlider('Light', max_value=100)
    ...
    def __thread_tick(self):
        ...
        self._slave1_latency_label.setText(f'{state.slave1_latency}')
        self._slave2_latency_label.setText(f'{state.slave2_latency}')
